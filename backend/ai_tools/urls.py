...
from .views import (
    AnalyzeAIQuestionView,
    BulkAddAIQuestionsToQuizView,
    GenerateAIQuestionsView,
    RegenerateAIQuestionView,
    SaveAIQuestionsToQuestionBankView,
)
...
urlpatterns = [
    ...
    path('ai/questions/regenerate', RegenerateAIQuestionView.as_view(), name='ai-regenerate-no-slash'),
    path('ai/questions/regenerate/', RegenerateAIQuestionView.as_view(), name='ai-regenerate'),
    path('ai/questions/analyze', AnalyzeAIQuestionView.as_view(), name='ai-analyze-no-slash'),
    path('ai/questions/analyze/', AnalyzeAIQuestionView.as_view(), name='ai-analyze'),
